...
def markdown(index, content):
    nb.cells[index] = nbformat.v4.new_markdown_cell(content.strip())


def code(index, content):
    nb.cells[index] = nbformat.v4.new_code_cell(content.strip())
