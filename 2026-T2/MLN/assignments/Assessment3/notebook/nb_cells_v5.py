...
CEILING_READ = md(r"""
Two different mechanisms are at work here, and they are worth separating rather than calling both an extrapolation ceiling.
...
The measurement settles what actually happened. The 2011 maximum was 6,043 rentals, while 2012 reached 8,714. Random Forest's largest prediction was 5,567 and Gradient Boosting's was 5,491, both below the 2011 ceiling, with mean under-predictions of 1,568 and 1,995 rentals per day. KNN also stayed below it. So Gradient Boosting was free to exceed the ceiling and did not, which is a stronger result than saying it could not: nothing in the 2011 data pushed it upward, because the growth it needed to reproduce was not there to learn.
...
The measured conclusion survived the correction: every tree-based candidate did stay below the 2011 ceiling here. What changed is why. It is an empirical finding about this dataset rather than an arithmetic guarantee, and I had been presenting an assumption as a property. Checking a claim against the mechanism instead of against the models that happen to share a name is the thing I actually took away, and it is why the simplest candidate transferring best is a result rather than a foregone conclusion.
...
CELLS = [
    ...
    EVALUATION_HEAD, SUMMARY, CEILING, CEILING_READ, EXPLAIN_HEAD,
