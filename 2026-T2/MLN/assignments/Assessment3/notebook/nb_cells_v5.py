...
This appendix sketches the engineering extension named in Section 6.3. The binding constraint on
it is Section 4.2, not Section 4.1: what the model may be deployed to do is set by the experiment
it failed, not by the one it won.
...
- It may **not** be described as machine learning, because it is not. Presenting a seven-day mean
  as a model would misrepresent the one honest finding this project has about forecasting.
