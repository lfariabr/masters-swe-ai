...
| Model | Accuracy | Macro-F1 | Accuracy on conflicting-aspect subset |
|---|---|---|---|
| TF-IDF + logistic regression (sentence-only baseline) | to be reported (A3) | to be reported (A3) | to be reported (A3) |
