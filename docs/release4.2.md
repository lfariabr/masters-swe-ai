...
> From data architecture through classical and deep learning to governed analytical decisions.

## Release Gate

| Subject | Current repository state | Release requirement |
|---|---|---|
...
- Completed the progression from CRISP-DM and classical models through explainability, learning theory, enterprise ML and weak supervision.
- Submitted all three assessments and preserved the negative forward-temporal finding from the Capital Bikeshare project.
- Shipped the Sommelier API portfolio outcome with separate estimation and screening contracts, provenance and parity tests.
- Added the [MLN601 subject summary](../2026-T2/MLN/MLN601_subject-summary.md).

### BDA601

- Completed all 12 modules from the Big Data Vs and lakehouse architecture through Spark, model evaluation, clustering, association rules, graph analytics, privacy and security.
- Earned `93/100` for the Big Retail lakehouse design and `91/100` for the Spark telco-churn analysis; Assessment 3 is submitted with its grade pending.
