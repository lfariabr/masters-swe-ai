...
|---------|---------------------|----------------|----------------|----------------|
| **Sommelier API** | Two-lens wine quality predictor on the UCI Wine Quality dataset (6,497 reds + whites): a FastAPI service serving a RandomForest regressor (R² 0.50) and a DecisionTree classifier (ROC-AUC 0.81), with a Streamlit tasting-room UI and a local/API inference toggle. Python, FastAPI, scikit-learn, Streamlit, Render. | ✅ | [Repo](https://github.com/lfariabr/sommelier-api) | [App](https://sommelier-api.streamlit.app/) / [API](https://sommelier-api-yd1m.onrender.com/docs) / [Article](https://dev.to/lfariaus/i-gave-the-same-6497-wines-to-two-models-and-asked-them-different-questions-4hdn) |
