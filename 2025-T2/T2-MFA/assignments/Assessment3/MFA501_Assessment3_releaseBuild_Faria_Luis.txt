# EigenAI - Mathematical Foundations of AI Portal

## Live Environment
Hosted on Streamlit: https://eigen-ai.streamlit.app/

## Open-Sourced Code
Available at: https://github.com/lfariabr/masters-swe-ai/tree/master/2025-T2/T2-MFA/projects/eigenai
...
- [resolvers/](masters_SWEAI/2025-T2/T2-MFA/projects/eigenai/resolvers:0:0-0:0) - Mathematical algorithms
  ...
  - [integrals.py](masters_SWEAI/2025-T2/T2-MFA/projects/eigenai/resolvers/integrals.py:0:0-0:0) - Numerical integration methods
  - [rrbf.py](masters_SWEAI/2025-T2/T2-MFA/projects/eigenai/resolvers/rrbf.py:0:0-0:0) - RRBF gradient computation
  - [hill_climber.py](masters_SWEAI/2025-T2/T2-MFA/projects/eigenai/resolvers/hill_climber.py:0:0-0:0) - Hill climbing algorithm
  - [constructor.py](masters_SWEAI/2025-T2/T2-MFA/projects/eigenai/resolvers/constructor.py:0:0-0:0) - Binary image constructor
...
- Set 2 - Problem 1: Numerical integration (trapezoid, Simpson, adaptive Simpson methods)
- Set 2 - Problem 2: RRBF gradient computation with manual backpropagation
- Set 3 - Problem 1: Binary image constructor using Hill Climber algorithm
...
- Solution: Run `pip install streamlit sympy matplotlib numpy` manually

Issue: Browser doesn't open automatically
- Solution: Open browser and go to http://localhost:8501

### Video Demonstration
A screen recording demonstrating the full execution of all features is included in the submission.
The video shows:
- Application startup and navigation
- Input validation and error handling
- Calculation process and results
- Visualization features (matplotlib plots and sympy expressions for mathematical notation)
